...
const Navbar: React.FC = () => {
  ...
  return (
    <header 
      className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-[#09121D]/90 backdrop-blur-[20px] border-b border-[#2b3036]/20 py-1 px-6 lg:px-16 shadow-[0_4px_30px_rgba(0,0,0,0.1)]"
    >
