          ...
          <div className="lg:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-arc-text-secondary text-sm inline-block transition-all duration-200 hover:text-arc-text-main hover:scale-105 focus-visible:outline-none focus-visible:text-[#a0bce4] focus-visible:underline focus-visible:underline-offset-4 rounded">Features</a></li>
                <li><a href="#" className="text-arc-text-secondary text-sm inline-block transition-all duration-200 hover:text-arc-text-main hover:scale-105 focus-visible:outline-none focus-visible:text-[#a0bce4] focus-visible:underline focus-visible:underline-offset-4 rounded">Security</a></li>
                <li><a href="#" className="text-arc-text-secondary text-sm inline-block transition-all duration-200 hover:text-arc-text-main hover:scale-105 focus-visible:outline-none focus-visible:text-[#a0bce4] focus-visible:underline focus-visible:underline-offset-4 rounded">Bridge</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-arc-text-secondary text-sm inline-block transition-all duration-200 hover:text-arc-text-main hover:scale-105 focus-visible:outline-none focus-visible:text-[#a0bce4] focus-visible:underline focus-visible:underline-offset-4 rounded">Terms of Service</a></li>
                <li><a href="#" className="text-arc-text-secondary text-sm inline-block transition-all duration-200 hover:text-arc-text-main hover:scale-105 focus-visible:outline-none focus-visible:text-[#a0bce4] focus-visible:underline focus-visible:underline-offset-4 rounded">Privacy Policy</a></li>
                <li><a href="#" className="text-arc-text-secondary text-sm inline-block transition-all duration-200 hover:text-arc-text-main hover:scale-105 focus-visible:outline-none focus-visible:text-[#a0bce4] focus-visible:underline focus-visible:underline-offset-4 rounded">Security Policy</a></li>
              </ul>
            </div>
